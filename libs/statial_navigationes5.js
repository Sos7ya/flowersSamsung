...
(function ($) {
  ...
  function getSectionDefaultElement(sectionId) {
    var defaultElement = parseSelector(_sections[sectionId].defaultElement);

if (Array.isArray(defaultElement)) {
    defaultElement = defaultElement.find(function (elem) {
        return isNavigable(elem, sectionId, true);
    });
} else {
    console.error("Вот такие пироги",defaultElement);
}
